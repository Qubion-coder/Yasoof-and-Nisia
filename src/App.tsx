              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center z-[120] bg-black/40 backdrop-blur-[2px]">
                ...
                >
                  <motion.div
                    ...
                    className="mb-12"
                  >
                    <h2 className="font-playball text-4xl md:text-6xl text-[#9d6065] mb-6 drop-shadow-2xl">Waleema Ceremony</h2>
            ...
            <section className="w-full relative flex items-center justify-center overflow-hidden bg-white min-h-[85vh]">
              ...
              <div className="relative z-10 w-full max-w-5xl px-6 py-24 md:py-32 text-center">
                <motion.p
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="text-[10px] md:text-xs tracking-[0.6em] font-bold text-[#7c4146] drop-shadow-sm uppercase"
                >
                  Waleema Ceremony
                </motion.p>
                  ...
                  <div className="text-[#9d6065] space-y-4">
                    <div className="space-y-4 mb-8">
                      ...
                      <div className="flex flex-col items-center justify-center gap-2">
                        <span className="text-base font-serif text-stone-700">SON OF MR. AND MRS. A H haja maideen</span>
                        <span className="text-base font-serif text-stone-700">&</span>
                        <span className="text-base font-serif text-stone-700">DAUGHTER OF Mr and mrs mohamed nisar</span>
                      </div>
                    </div>
                    ...
                    <p className="font-serif text-base md:text-[13px] font-medium leading-loose max-w-3xl border-t border-b border-[#eedadb]/50 py-6">
                      ...
                      <span className="text-[#bd8186] text-xl my-2 block font-playball">{INVITATION.couple.groomFull} & {INVITATION.couple.brideFull}</span>
                    </p>
                  </div>
                </motion.div>
                        ...
                        <div className="space-y-10">
                          ...
                          <div className="flex items-start gap-8">
                            ...
                            <div className="space-y-1">
                              <h4 className="text-[#9d6065]/40 font-bold text-[10px] uppercase tracking-[0.5em] font-cinzel">Waleema Ceremony</h4>
                              <p className="text-xl md:text-2xl text-[#9d6065] font-cinzel leading-relaxed tracking-wide font-bold">
